...
export default function BACCalculator() {
  ...
  const [drinks, setDrinks] = useState<Drink[]>([
    { id: "1", type: "", volume: "", volumeUnit: "oz", abv: "", quantity: "1" },
  ...
  const updateDrink = (id: string, field: keyof Drink, value: string) => {
    setDrinks((prevDrinks) => prevDrinks.map((drink) => (drink.id === id ? { ...drink, [field]: value } : drink)))
  }
  ...
  const calculateBAC = () => {
    ...
    // Calculate total alcohol in grams using exact specification formula
    ...
    // Calculate BAC using exact formula
    ...
    // Calculate initial BAC (at time 0) for display
    ...
    setResult({
      bac: finalBAC,
      bacPercentage: finalBAC * 100, // Convert to percentage for display
      interpretation,
      warningLevel,
      timeUntilSober,
      standardDrinks,
  ...
  const resetCalculator = () => {
    ...
    setTimeHours("")
    setTimeMinutes("")
    setDrinks([{ id: "1", type: "", volume: "", volumeUnit: "oz", abv: "", quantity: "1" }]) // Reset with quantity
    setResult(null)
    setShowResult(false)
    setErrors({})
  }
            ...
            <div className="flex justify-between items-center h-20">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">BAC Calculator</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <nav className="bg-white border-b px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center space-x-2 py-4 text-sm">
              ...
              <span className="text-gray-400">/</span>
              <span className="text-gray-900 font-medium">BAC Calculator</span>
            </div>
          </div>
        </nav>
        ...
        <main className="py-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">BAC Calculator</h1>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Calculate Blood Alcohol Concentration (BAC) using the Watson formula. More accurate than traditional
                Widmark equation with precise alcohol-to-grams conversion.
              </p>
            </div>
                ...
                <Card className="shadow-2xl border-0 bg-white">
                  <CardHeader className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-t-lg border-b px-8 py-6">
                    <CardTitle className="flex items-center space-x-3 text-2xl">
                      ...
                      <span>Personal Information & Drinks</span>
                    </CardTitle>
                    <CardDescription className="text-base">
                      Enter your information and alcohol consumption details
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="p-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <Label className="text-sm font-medium text-gray-700 mb-3 flex items-center">
                            ...
                            <div className="group relative ml-2">
                              ...
                              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10 pointer-events-none">
                                Required for Watson body water calculation
                              </div>
                            </div>
                          </Label>
                          <Input
                        ...
                        <div>
                          ...
                          <div className="flex space-x-2">
                            <Input
                              className={`flex-1 h-12 rounded-xl border-gray-200 focus:border-purple-400 focus:ring-purple-200 shadow-sm ${
                      ...
                      <div className="mt-6">
                        <Label className="text-sm font-medium text-gray-700 mb-3 flex items-center">
                          ...
                          <div className="group relative ml-2">
                            <HelpCircle className="h-4 w-4 text-gray-400 cursor-help group-hover:text-gray-600" />
                            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10 pointer-events-none">
                              Time elapsed since your first alcoholic drink
                            </div>
                          </div>
                        </Label>
                        <div className="flex space-x-4">
                            ...
                            <div className="relative">
                              ...
                              <Input
                                className={`w-full pl-10 h-12 rounded-xl border-gray-200 focus:border-purple-400 focus:ring-purple-200 shadow-sm ${
                                  errors.time ? "border-red-300 focus:border-red-400 focus:ring-red-200" : ""
                                }`}
                                type="number"
                                step="1"
                                min="0"
                          ...
                          <div className="flex-1">
                            <Input
                              className={`w-full h-12 rounded-xl border-gray-200 focus:border-purple-400 focus:ring-purple-200 shadow-sm ${
                                errors.time ? "border-red-300 focus:border-red-400 focus:ring-red-200" : ""
                              }`}
                              type="number"
                              step="1"
                    ...
                    <div className="mb-6">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-semibold text-gray-900">Alcohol Consumed</h3>
                        <Button
                          onClick={addDrink}
                          variant="outline"
                          size="sm"
                      ...
                      {drinks.map((drink, index) => (
                        <div key={drink.id} className="mb-4 p-4 bg-purple-50 rounded-lg border border-purple-200">
                          <div className="flex items-center justify-between mb-3">
                            <h4 className="font-medium text-purple-700">Drink {index + 1}</h4>
                            {drinks.length > 1 && (
                              <Button
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                            ...
                            <div>
                              ...
                              <Input
                                className="h-10 rounded-lg border-gray-200 focus:border-purple-400 focus:ring-purple-200"
                                type="number"
                                step="0.1"
                                min="0.1"
                                placeholder="1"
                            ...
                            <div>
                              ...
                              <div className="flex space-x-1">
                                <Input
                                  className="flex-1 h-10 rounded-lg border-gray-200 focus:border-purple-400 focus:ring-purple-200"
                                  type="number"
                                  step="0.1"
                                  min="0"
                                  placeholder="0"
                                ...
                                <Select
                                  ...
                                  onValueChange={(value) => updateDrink(drink.id, "volumeUnit", value)}
                                >
                            ...
                            {/* ABV */}
                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-2 block">ABV %</Label>
                              <Input
                                className="h-10 rounded-lg border-gray-200 focus:border-purple-400 focus:ring-purple-200"
                                type="number"
                                step="0.1"
                    ...
                    <div className="mb-6 p-4 bg-purple-50 rounded-lg border border-purple-200">
                      <p className="text-sm text-gray-700">
                        <strong>Metric Widmark Formula:</strong> BAC(%) = A_g ÷ (r × W_kg × 10) - (β × t)
                      </p>
                      <p className="text-xs text-gray-600 mt-1">
                        A_g = alcohol grams, r = distribution ratio (male: 0.68, female: 0.55), β = 0.017/hour
                        elimination
                      </p>
                    </div>
              ...
              <div className="hidden lg:block">
                <Card className="shadow-2xl border-0 bg-gradient-to-br from-purple-50 to-violet-100 h-full">
                  <CardHeader className="w-full text-center mb-2">
                    ...
                    <CardTitle className="text-2xl font-bold text-purple-700 tracking-tight">BAC Results</CardTitle>
                  </CardHeader>
                    ...
                    {showResult && result ? (
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 gap-3 text-sm">
                          ...
                          <div className="bg-white p-3 rounded-lg border border-purple-200">
                            <p className="text-lg font-bold text-purple-900">{result.timeUntilSober.toFixed(1)}h</p>
                            <p className="text-gray-600">Until Sober</p>
                          </div>
                          <div className="bg-white p-3 rounded-lg border border-purple-200">
                            <p className="text-sm font-bold text-purple-900">{result.standardDrinks.toFixed(1)}</p>
                            <p className="text-gray-600">Standard Drinks</p>
                          </div>
                        </div>
                      </div>
                    ) : (
                      <div className="text-center">
                        ...
                        <p className="text-gray-500 text-base">
                          Enter your information and drinks, then click{" "}
                          <span className="font-semibold text-purple-600">Calculate</span> to see BAC.
                        </p>
                      </div>
                    )}
                  </CardContent>
                ...
                <Card className="shadow-2xl border-0 bg-white">
                  <CardHeader className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-t-lg border-b px-8 py-6">
                    <CardTitle className="flex items-center space-x-3 text-2xl">
                      ...
                      <span>Detailed BAC Analysis</span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                      ...
                      <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl border border-purple-200">
                        ...
                        <h3 className="text-lg font-semibold text-purple-700 mb-2">Time Until Sober</h3>
                        <p className="text-2xl font-bold text-purple-900 mb-1">
                          {result.timeUntilSober.toFixed(1)} hours
                        </p>
                        <p className="text-sm text-purple-600">At 0.017/hour elimination</p>
                      </div>
                      <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl border border-purple-200">
                        <div className="w-12 h-12 bg-gradient-to-r from-purple-600 to-violet-700 rounded-full flex items-center justify-center mx-auto mb-3">
                          <Calculator className="w-6 h-6 text-white" />
                        </div>
                        <h3 className="text-lg font-semibold text-purple-700 mb-2">Standard Drinks</h3>
                        <p className="text-2xl font-bold text-purple-900 mb-1">{result.standardDrinks.toFixed(1)}</p>
                        <p className="text-sm text-purple-600">Total consumed</p>
                      </div>
                      <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl border border-purple-200">
                        <div className="w-12 h-12 bg-gradient-to-r from-purple-600 to-violet-700 rounded-full flex items-center justify-center mx-auto mb-3">
                          <AlertTriangle className="w-6 h-6 text-white" />
                        </div>
                        <h3 className="text-lg font-semibold text-purple-700 mb-2">Pure Alcohol</h3>
                        <p className="text-2xl font-bold text-purple-900 mb-1">
                          {result.totalAlcoholGrams.toFixed(1)}g
                        </p>
                        <p className="text-sm text-purple-600">Total grams</p>
                      </div>
                    </div>

                    <div className="mt-6 p-4 bg-gradient-to-r from-purple-50 to-violet-50 rounded-lg border border-purple-200">
                      <h4 className="font-semibold text-purple-700 mb-2">Calculation Steps (Widmark Formula):</h4>
                      <div className="text-gray-700 space-y-1">
                        <p>
                          <strong>Step 1:</strong> Total alcohol = {result.totalAlcoholGrams.toFixed(1)}g (Volume × ABV
                          × 0.789 × Quantity)
                        </p>
                        <p>
                          <strong>Step 2:</strong> Distribution ratio = {result.distributionRatio} (
                          {gender === "male" ? "male" : "female"} metric constant)
                        </p>
                        <p>
                          <strong>Step 3:</strong> Initial BAC = {result.totalAlcoholGrams.toFixed(1)}g ÷ (
                          {result.distributionRatio} × {result.weightInKg.toFixed(1)}kg × 10) ={" "}
                          {(result.bac0 * 100).toFixed(3)}%
                        </p>
                        <p>
                          <strong>Step 4:</strong> Current BAC = {(result.bac0 * 100).toFixed(3)}% - (
                          {result.eliminationRate} × {result.totalHours.toFixed(1)}h) ={" "}
                          {result.bacPercentage.toFixed(3)}%
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-red-600">
                            This BAC calculator provides an estimate only. Actual BAC may vary based on individual
                            factors. Do not drink and drive. Always use designated drivers or alternative
                            transportation.
                          </p>
                        </div>
                      </div>
              ...
              <Card className="shadow-2xl border-0 bg-gradient-to-br from-purple-50 to-violet-100 p-8">
                ...
                <CardContent className="w-full">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      <h3 className="text-lg font-semibold text-purple-700 mb-3">What is BAC?</h3>
                      <p className="text-gray-700 mb-4">
                        Blood Alcohol Concentration (BAC) measures the amount of alcohol in your bloodstream as a
                        percentage. This calculator uses the Watson formula for more accurate Total Body Water
                        calculation compared to traditional Widmark equation.
                      </p>
                      <h3 className="text-lg font-semibold text-purple-700 mb-3">Watson vs Widmark Formula</h3>
                      <ul className="list-disc list-inside text-gray-700 space-y-2">
                        <li>Watson: Uses age, height, weight, and gender for precise TBW</li>
                        <li>Widmark: Uses simple gender constants (less accurate)</li>
                        <li>Elimination rate: 0.017/hour (more accurate than 0.015)</li>
                        <li>Alcohol conversion: Volume × ABV × 0.789 density</li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-purple-700 mb-3">Metric Widmark Formula</h3>
                      <ul className="list-disc list-inside text-gray-700 space-y-2">
                        <li>Formula: BAC(%) = A_g ÷ (r × W_kg × 10) - β × t</li>
                        <li>Distribution ratios: Male 0.68, Female 0.55 (metric constants)</li>
                        <li>Elimination rate: 0.017% per hour (updated standard)</li>
                        <li>Alcohol conversion: Volume(ml) × ABV% × 0.789 density</li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-purple-700 mb-3">Standard Drink Equivalents</h3>
                      <div className="bg-white p-4 rounded-lg border border-purple-200 mb-4">
                        <p className="text-gray-700 mb-2">
                          <strong>1 Standard Drink = 14g pure alcohol:</strong>
                        </p>
                        <p className="text-gray-700">• 12 oz beer (5% ABV)</p>
                        <p className="text-gray-700">• 5 oz wine (12% ABV)</p>
                        <p className="text-gray-700">• 1.5 oz liquor (40% ABV)</p>
                      </div>
                      <div className="bg-white p-4 rounded-lg border border-purple-200">
                        <p className="text-gray-700 mb-2">
                          <strong>Elimination Rate:</strong>
                        </p>
                        <p className="text-gray-700">
                          The liver eliminates alcohol at approximately 0.017% BAC per hour (updated from older 0.015
                          rate), regardless of body size or drinking experience.
                        </p>
                      </div>
                      <div className="mt-4 p-3 bg-red-50 rounded-lg border border-red-200">
                        <p className="text-sm text-red-800">
                          <strong>Safety Note:</strong> This calculator is for educational purposes only. Never rely on
                          BAC estimates to determine if you're safe to drive.
                        </p>
                      </div>
                    </div>
                  </div>
