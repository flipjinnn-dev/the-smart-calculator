...
interface PregnancyConceptionCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function PregnancyConceptionCalculatorClient({ content, guideContent }: PregnancyConceptionCalculatorClientProps) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-pink-50">
        ...
        title="Related Health Calculators" />
          ...
          <RatingProfileSection
            entityId="pregnancy-conception-calculator"
