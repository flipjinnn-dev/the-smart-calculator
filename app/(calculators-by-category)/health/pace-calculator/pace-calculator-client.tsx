...
interface PaceCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function PaceCalculatorClient({ content, guideContent }: PaceCalculatorClientProps) {
