...
interface BodySurfaceAreaCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function BodySurfaceAreaCalculatorClient({ content, guideContent }: BodySurfaceAreaCalculatorClientProps) {
...
<SimilarCalculators calculators={[{
        ...
        title="Related Health Calculators" />
          ...
          <RatingProfileSection
            entityId="body-surface-area-calculator"
