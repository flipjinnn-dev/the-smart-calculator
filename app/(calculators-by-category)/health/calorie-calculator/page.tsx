...
export default function CalorieCalculatorCalculator() {
  ...
  const {
    ...
    loading,
    error: contentError
  } = useCalculatorContent('calorie-calculator', language, "calculator-ui");
  const { content: guideContent, loading: guideLoading, error: guideError } = useCalculatorContent('calorie-calculator', language, "calculator-guide");
  ...
  const contentData = content || {
    ...
    "errors": "",
    "tooltips": "",
    "personal_information_0": "",
    "enter_your_details_to_calculate_calorie_needs_1": "",
    "age_2": "",
    "gender_3": "",
    "male_4": "",
    "female_5": "",
    ...
    "weight_kg_7": "",
    "activity_level_8": "",
    "sedentary_littleno_exercise_9": "",
    "light_light_exercise_13_daysweek_10": "",
    "moderate_moderate_exercise_35_daysweek_11": "",
    "active_hard_exercise_67_daysweek_12": "",
    "very_active_very_hard_exercise_physical_job_13": "",
    "calculate_14": "",
    "your_calorie_needs_15": "",
    "daily_calorie_requirements_for_different_goals_16": "",
    "maintenance_calories_17": "",
    "calories_to_maintain_current_weight_18": "",
    "weight_loss_1_lbweek_19": "",
    "calories_20": "",
    "weight_gain_1_lbweek_21": "",
    "calories_22": "",
    "basal_metabolic_rate_bmr_23": "",
    "calories_24": "",
    "enter_your_information_to_calculate_calorie_needs_25": ""
  }
