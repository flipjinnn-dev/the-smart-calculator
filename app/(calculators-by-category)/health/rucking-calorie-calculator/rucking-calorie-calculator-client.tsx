...
interface RuckingCalorieCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function RuckingCalorieCalculatorClient({ content, guideContent }: RuckingCalorieCalculatorClientProps) {
