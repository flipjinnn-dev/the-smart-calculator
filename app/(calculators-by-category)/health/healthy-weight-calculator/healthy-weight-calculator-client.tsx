...
interface HealthyWeightCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function HealthyWeightCalculatorClient({ content, guideContent }: HealthyWeightCalculatorClientProps) {
