...
interface MagicNumberCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function MagicNumberCalculatorClient({ content, guideContent }: MagicNumberCalculatorClientProps) {
      ...
      <main className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <RatingProfileSection
            entityId="magic-number-calculator"
