...
interface FieldingIndependentPitchingCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function FieldingIndependentPitchingCalculatorClient({ content, guideContent }: FieldingIndependentPitchingCalculatorClientProps) {
