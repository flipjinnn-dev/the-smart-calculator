...
interface EarnedRunAverageCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function EarnedRunAverageCalculatorClient({ content, guideContent }: EarnedRunAverageCalculatorClientProps) {
