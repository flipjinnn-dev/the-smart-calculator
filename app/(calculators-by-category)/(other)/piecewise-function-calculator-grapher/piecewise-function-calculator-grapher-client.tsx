...
interface PiecewiseFunctionCalculatorGrapherClientProps {
  content: any;
  guideContent: any;
}

export default function PiecewiseFunctionCalculatorGrapherClient({ content, guideContent }: PiecewiseFunctionCalculatorGrapherClientProps) {
