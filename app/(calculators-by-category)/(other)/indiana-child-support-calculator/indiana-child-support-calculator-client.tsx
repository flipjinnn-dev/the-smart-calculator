...
interface IndianaChildSupportCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function IndianaChildSupportCalculatorClient({ content, guideContent }: IndianaChildSupportCalculatorClientProps) {
