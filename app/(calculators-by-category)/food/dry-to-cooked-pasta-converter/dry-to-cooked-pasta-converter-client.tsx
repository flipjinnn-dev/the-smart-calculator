...
interface DryToCookedPastaConverterClientProps {
  content: any;
  guideContent: any;
}

export default function DryToCookedPastaConverterClient({ content, guideContent }: DryToCookedPastaConverterClientProps) {
