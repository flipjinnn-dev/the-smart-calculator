...
interface CookingMeasurementConverterClientProps {
  content: any;
  guideContent: any;
}

export default function CookingMeasurementConverterClient({ content, guideContent }: CookingMeasurementConverterClientProps) {
