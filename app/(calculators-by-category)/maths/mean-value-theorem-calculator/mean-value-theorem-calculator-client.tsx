...
interface MeanValueTheoremCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function MeanValueTheoremCalculatorClient({ content, guideContent }: MeanValueTheoremCalculatorClientProps) {
