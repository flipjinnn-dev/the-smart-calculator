...
interface SquareRootCurveCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function SquareRootCurveCalculatorClient({ content, guideContent }: SquareRootCurveCalculatorClientProps) {
