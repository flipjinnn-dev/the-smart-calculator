...
export default function RelativeExtremaCalculator() {
  const pathname = usePathname();
  const language = pathname?.startsWith('/br') ? 'br' : pathname?.startsWith('/pl') ? 'pl' : pathname?.startsWith('/de') ? 'de' : pathname?.startsWith('/es') ? 'es' : 'en';
  
  const {
    content,
    loading,
    error: contentError
  } = useCalculatorContent('relative-extrema-calculator', language, "calculator-ui");
  const { content: guideContent, loading: guideLoading, error: guideError } = useCalculatorContent('relative-extrema-calculator', language, "calculator-guide");
        ...
        <div className="max-w-7xl mx-auto">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="p-6 bg-purple-50 rounded-lg border border-purple-200">
                    <h3 className="text-lg font-semibold text-purple-900 mb-4">
                      {contentData.step_by_step || "Step-by-Step Solution"}
                    </h3>
          ...
          <div className="mt-12">
            <SimilarCalculators calculators={[{
              ...
              calculatorDescription: "Apply the Mean Value Theorem to find points on a curve"
            }, {
