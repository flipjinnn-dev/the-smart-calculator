...
interface PercentErrorCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function PercentErrorCalculatorClient({ content, guideContent }: PercentErrorCalculatorClientProps) {
