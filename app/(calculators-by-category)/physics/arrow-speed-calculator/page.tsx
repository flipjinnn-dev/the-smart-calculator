            ...
            <div className="mt-12">
              <Card className="shadow-2xl border-0 bg-gradient-to-br from-slate-50 to-blue-100 p-8">
                <CardHeader className="w-full flex flex-row items-center justify-start mb-4">
                  ...
                  <CardTitle className="text-2xl font-bold text-slate-700 tracking-tight">{contentData.understanding_arrow_speed_ibo_ratings_32}</CardTitle>
                </CardHeader>
                <CardContent className="w-full">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      <h3 className="text-lg font-semibold text-slate-700 mb-3">{contentData.ibo_rating_explained_33}</h3>
                      <p className="text-gray-700 mb-4">{contentData.ibo_international_bowhunting_organization_rating_i_34}</p>
                      <h3 className="text-lg font-semibold text-slate-700 mb-3">{contentData.performance_factors_35}</h3>
                      <ul className="list-disc list-inside text-gray-700 space-y-2">
                        <li>{contentData.draw_length_10_fps_per_inch_change_36}</li>
                        <li>{contentData.draw_weight_2_fps_per_pound_change_37}</li>
                        <li>{contentData.arrow_weight_1_fps_per_3_grains_38}</li>
                        <li>{contentData.string_accessories_1_fps_per_3_grains_39}</li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-slate-700 mb-3">{contentData.sample_calculation_40}</h3>
                      <div className="bg-white p-4 rounded-lg border border-slate-200">
                        <p className="text-gray-700 mb-2">
                          <strong>{contentData.example_41}</strong>
                        </p>
                        <p className="text-gray-700">{contentData.ibo_rating_320_fps_42}</p>
                        <p className="text-gray-700">{contentData.draw_length_29_1_from_baseline_43}</p>
                        <p className="text-gray-700">{contentData.draw_weight_60_lb_10_lb_from_baseline_44}</p>
                        <p className="text-gray-700">{contentData.arrow_weight_400_gr_50_gr_from_baseline_45}</p>
                        <p className="text-gray-700 font-semibold mt-2">{contentData.result_320_10_20_167_273_fps_46}</p>
                      </div>
                      <p className="text-sm text-gray-600 mt-3">{contentData.momentum_and_kinetic_energy_are_calculated_using_p_47}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
