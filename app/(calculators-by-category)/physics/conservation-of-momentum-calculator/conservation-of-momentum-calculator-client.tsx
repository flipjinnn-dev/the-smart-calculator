...
interface ConservationOfMomentumCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function ConservationOfMomentumCalculatorClient({ content, guideContent }: ConservationOfMomentumCalculatorClientProps) {
