...
interface CarJumpDistanceCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function CarJumpDistanceCalculatorClient({ content, guideContent }: CarJumpDistanceCalculatorClientProps) {
