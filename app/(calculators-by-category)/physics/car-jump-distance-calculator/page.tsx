...
export default function CarJumpCalculator() {
  ...
  const TrajectoryChart = ({ trajectoryPoints }: { trajectoryPoints: any[] }) => {
    ...
    return (
      <div className="mt-4 p-4 bg-white rounded-lg border border-orange-200">
        <h4 className="text-sm font-semibold text-gray-700 mb-2">Trajectory Path</h4>
        <svg width={width} height={height} className="border border-gray-200 rounded">
          ...
          <line
            x1={padding}
            y1={height - padding - (result.landingHeight - minY) * scaleY}
            x2={width - padding}
            y2={height - padding - (result.landingHeight - minY) * scaleY}
            stroke="#22c55e"
            strokeWidth="2"
            strokeDasharray="5,5"
          />
          ...
          {/* Landing point */}
          <circle
            cx={padding + result.range * scaleX}
            cy={height - padding - (result.landingHeight - minY) * scaleY}
            r="4"
            fill="#dc2626"
          />
        </svg>
            ...
            <div className="flex justify-between items-center h-20">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Car Jump Distance Calculator</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <nav className="bg-white border-b px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center space-x-2 py-4 text-sm">
              ...
              <span className="text-gray-400">/</span>
              <span className="text-gray-900 font-medium">Car Jump Distance Calculator</span>
            </div>
          </div>
        </nav>
        ...
        <main className="py-8 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Car Jump Distance Calculator</h1>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Calculate car jump distance using projectile motion physics. Includes advanced options for air drag and
                vehicle rotation effects.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <CardContent className="p-8">
                    <Tabs defaultValue="basic" className="w-full">
                      <TabsList className="bg-gradient-to-r from-orange-50 to-red-50 grid grid-cols-3 gap-1 mb-6 h-auto p-2 rounded-xl border border-orange-200 shadow-sm">
                        <TabsTrigger
                          value="basic"
                          className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-red-600 data-[state=active]:text-white data-[state=active]:shadow-lg rounded-lg py-3 px-4 text-sm font-semibold transition-all duration-300"
                        >
                          Basic
                        </TabsTrigger>
                        <TabsTrigger
                      ...
                      <TabsContent value="basic" className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            <Label className="text-sm font-medium text-gray-700 mb-3 block">Take-off Height</Label>
                            <div className="flex space-x-2">
                              <div className="relative flex-1">
                                ...
                                <Input
                                  ...
                                  step="0.1"
                                  value={takeoffHeight}
                                  onChange={(e) => setTakeoffHeight(Number(e.target.value))}
                                />
                              </div>
                          ...
                          <div>
                            <Label className="text-sm font-medium text-gray-700 mb-3 block">Landing Height</Label>
                            <div className="flex space-x-2">
                              <div className="relative flex-1">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                  <TrendingUp className="h-5 w-5 text-orange-500" />
                                ...
                                <Input
                                  ...
                                  step="0.1"
                                  value={landingHeight}
                                  onChange={(e) => setLandingHeight(Number(e.target.value))}
                                />
                              </div>
                          ...
                          <div>
                            <Label className="text-sm font-medium text-gray-700 mb-3 block">Ramp Angle</Label>
                            <div className="flex space-x-2">
                              <div className="relative flex-1">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <Input
                                  className={`pl-10 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm ${errors.rampAngle ? "border-red-500" : ""}`}
                                  type="number"
                                  step="1"
                                  value={rampAngle}
                          ...
                          <div>
                            <Label className="text-sm font-medium text-gray-700 mb-3 block">Take-off Speed</Label>
                            <div className="flex space-x-2">
                              <div className="relative flex-1">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <Input
                                  className={`pl-10 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm ${errors.speedKmh ? "border-red-500" : ""}`}
                                  type="number"
                                  step="1"
                                  value={speedKmh}
                          ...
                          <div className="md:col-span-2">
                            <Label className="text-sm font-medium text-gray-700 mb-3 block">Gravity</Label>
                            <div className="flex space-x-2">
                              <div className="relative flex-1">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                  <Calculator className="h-5 w-5 text-orange-500" />
                                ...
                                <Input
                                  className={`pl-10 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm ${errors.gravity ? "border-red-500" : ""}`}
                                  type="number"
                                  step="0.001"
                                  value={gravity}
                              ...
                              <Select value={gravityUnit} onValueChange={setGravityUnit}>
                                ...
                                <SelectContent>
                                  <SelectItem value="ms2">m/s²</SelectItem>
                                </SelectContent>
                              </Select>
                            </div>
                      ...
                      <TabsContent value="drag" className="space-y-6">
                        <div className="flex items-center justify-center space-x-4 p-4 bg-gradient-to-r from-orange-100 to-red-100 rounded-xl border-2 border-orange-200">
                          ...
                          <Switch
                            checked={includeDrag}
                            onCheckedChange={setIncludeDrag}
                            className="data-[state=checked]:bg-orange-500"
                          />
                          <Label className="text-lg font-semibold text-orange-700">Include Air Drag Effects</Label>
                        </div>

                        {includeDrag && (
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-3 block">Air Density</Label>
                              <div className="flex space-x-2">
                                <Input
                                  className={`flex-1 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm ${errors.airDensity ? "border-red-500" : ""}`}
                                  type="number"
                                  step="0.001"
                                  value={airDensity}
                                ...
                                <Select value={airDensityUnit} onValueChange={setAirDensityUnit}>
                                  ...
                                  <SelectContent>
                                    <SelectItem value="kgm3">kg/m³</SelectItem>
                                  </SelectContent>
                                </Select>
                              </div>
                            ...
                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-3 block">Drag Coefficient</Label>
                              <Input
                                className={`h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm ${errors.dragCoefficient ? "border-red-500" : ""}`}
                                type="number"
                                step="0.01"
                            ...
                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-3 block">Reference Area</Label>
                              <div className="flex space-x-2">
                                <Input
                                  className={`flex-1 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm ${errors.referenceArea ? "border-red-500" : ""}`}
                                  type="number"
                                  step="0.1"
                                  value={referenceArea}
                                  onChange={(e) => setReferenceArea(Number(e.target.value))}
                                />
                                <Select value={referenceAreaUnit} onValueChange={setReferenceAreaUnit}>
                                  ...
                                  <SelectContent>
                                    ...
                                    <SelectItem value="in2">in²</SelectItem>
                                    <SelectItem value="cm2">cm²</SelectItem>
                                  </SelectContent>
                                </Select>
                              </div>
                              {errors.referenceArea && (
                                <p className="text-red-500 text-sm mt-1">{errors.referenceArea}</p>
                              )}
                            </div>

                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-3 block">Vehicle Mass</Label>
                              <div className="flex space-x-2">
                                <Input
                                  className={`flex-1 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm ${errors.vehicleMass ? "border-red-500" : ""}`}
                                  type="number"
                                  step="10"
                                  value={vehicleMass}
                                  onChange={(e) => setVehicleMass(Number(e.target.value))}
                                />
                      ...
                      <TabsContent value="rotation" className="space-y-6">
                        <div className="flex items-center justify-center space-x-4 p-4 bg-gradient-to-r from-orange-100 to-red-100 rounded-xl border-2 border-orange-200">
                          ...
                          <Switch
                            ...
                            onCheckedChange={setIncludeRotation}
                            className="data-[state=checked]:bg-orange-500"
                          />
                          <Label className="text-lg font-semibold text-orange-700">Include Car Rotation Effects</Label>
                        </div>
                        ...
                        {includeRotation && (
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-3 block">Wheelbase</Label>
                              <div className="flex space-x-2">
                                <Input
                                  className={`flex-1 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm ${errors.wheelbase ? "border-red-500" : ""}`}
                                  type="number"
                                  step="0.1"
                                  value={wheelbase}
                            ...
                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-3 block">Car Length</Label>
                              <div className="flex space-x-2">
                                <Input
                                  className={`flex-1 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm ${errors.carLength ? "border-red-500" : ""}`}
                                  type="number"
                                  step="0.1"
                                  value={carLength}
                                  onChange={(e) => setCarLength(Number(e.target.value))}
                                />
                            ...
                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-3 block">Car Width</Label>
                              <div className="flex space-x-2">
                                <Input
                                  className={`flex-1 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm ${errors.carWidth ? "border-red-500" : ""}`}
                                  type="number"
                                  step="0.1"
                                  value={carWidth}
                            ...
                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-3 block">Car Height</Label>
                              <div className="flex space-x-2">
                                <Input
                                  className={`flex-1 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm ${errors.carHeight ? "border-red-500" : ""}`}
                                  type="number"
                                  step="0.1"
                                  value={carHeight}
                            ...
                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-3 block">COM Offset</Label>
                              <div className="flex space-x-2">
                                <Input
                                  className="flex-1 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm"
                                  type="number"
                                  step="0.01"
                                  value={comOffset}
                                  onChange={(e) => setComOffset(Number(e.target.value))}
                                />
                            ...
                            <div>
                              <Label className="text-sm font-medium text-gray-700 mb-3 block">Form Angle</Label>
                              <div className="flex space-x-2">
                                <Input
                                  className="flex-1 h-12 rounded-xl border-gray-200 focus:border-orange-400 focus:ring-orange-200 shadow-sm"
                                  type="number"
                                  step="1"
                                  value={formAngle}
                                  onChange={(e) => setFormAngle(Number(e.target.value))}
                                />
                    ...
                    <div className="mt-8 p-4 bg-orange-50 rounded-lg border border-orange-200">
                      <p className="text-sm text-gray-700">
                        <strong>Basic Formula:</strong> Projectile motion with initial velocity v₀ at angle α
                        <br />
                        <strong>Range:</strong> R = v₀ₓ × t_f, where t_f is flight time to landing height
                      </p>
                    </div>

                    <Button
                      onClick={handleCalculate}
                      className="w-full h-12 text-lg bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 mt-6"
                    >
              ...
              <div className="">
                <Card
                  ref={resultsRef}
                  className="shadow-2xl border-0 bg-gradient-to-br from-orange-50 to-red-50 h-full flex flex-col justify-center items-center p-8"
                >
                  <CardHeader className="w-full flex flex-col items-center justify-center mb-2">
                    ...
                    <CardTitle className="text-2xl font-bold text-orange-700 tracking-tight">Jump Results</CardTitle>
                  </CardHeader>
                    ...
                    {showResult && result ? (
                      <div className="text-center space-y-4">
                        {result.error ? (
                          <div className="text-red-600">
                            <p className="text-lg font-semibold mb-2">No Solution</p>
                            <p className="text-sm">{result.error}</p>
                          </div>
                        ) : (
                          <>
                            <div>
                              <p className="text-lg text-gray-600 mb-2 font-medium">Jump Distance</p>
                              <p className="text-4xl font-extrabold text-orange-900 mb-2 drop-shadow-lg">
                                {result.range ? result.range.toFixed(1) : "0"} m
                              </p>
                            </div>
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              <div>
                                <p className="text-gray-600 font-medium">Flight Time</p>
                                <p className="text-xl font-bold text-red-700">
                                  {result.flightTime ? result.flightTime.toFixed(2) : "0"} s
                                </p>
                              </div>
                              <div>
                                <p className="text-gray-600 font-medium">Landing Speed</p>
                                <p className="text-xl font-bold text-red-700">
                                  {result.landingSpeed ? result.landingSpeed.toFixed(1) : "0"} m/s
                                </p>
                              </div>
                              <div>
                                <p className="text-gray-600 font-medium">Max Height</p>
                                <p className="text-xl font-bold text-red-700">
                                  {result.maxHeight ? result.maxHeight.toFixed(1) : "0"} m
                                </p>
                              </div>
                              <div>
                                <p className="text-gray-600 font-medium">Max Height Distance</p>
                                <p className="text-xl font-bold text-red-700">
                                  {result.maxHeightDistance ? result.maxHeightDistance.toFixed(1) : "0"} m
                                </p>
                              </div>
                            </div>
                            ...
                            {result.dragResults && (
                              <div className="mt-4 p-3 bg-white rounded-lg border border-orange-200">
                                <p className="text-xs text-gray-600 font-semibold mb-1">With Air Drag:</p>
                                <p className="text-xs text-gray-600">
                                  Range: {result.dragResults.range.toFixed(1)} m<br />
                                  Time: {result.dragResults.flightTime.toFixed(2)} s<br />
                                  Landing Speed: {result.dragResults.landingSpeed.toFixed(1)} m/s
                                </p>
                              </div>
                            )}

                            {result.rotationResults && (
                              <div className="mt-4 p-3 bg-white rounded-lg border border-orange-200">
                                <p className="text-xs text-gray-600 font-semibold mb-1">Car Rotation:</p>
                                <p className="text-xs text-gray-600">
                                  Landing Angle: {result.rotationResults.landingAngle.toFixed(1)}°<br />
                                  Angular Velocity: {result.rotationResults.angularVelocity.toFixed(1)} °/s
                                </p>
                              </div>
                            )}
                          </>
                      ...
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-gray-500 text-center text-base">
                          Enter parameters and click <span className="font-semibold text-orange-600">Calculate</span> to
                          see results.
                        </p>
                      </div>
                    )}
            ...
            <div className="mt-12">
              <Card className="shadow-2xl border-0 bg-gradient-to-br from-orange-50 to-red-50 p-8">
                ...
                <CardContent className="w-full space-y-6">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Projectile Motion Basics</h3>
                    <p className="text-gray-700 leading-relaxed">
                      Car jumps follow projectile motion principles. The vehicle becomes a projectile once it leaves the
                      ramp, with initial velocity components determined by speed and ramp angle.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-white p-4 rounded-lg border border-orange-200">
                      <p className="text-sm text-gray-700 mb-2">
                        <strong>Given:</strong> h₀ = 1.5 m, hₗ = 0.5 m, α = 10°, speed = 90 km/h (25.0 m/s)
                      </p>
                      <p className="text-sm text-gray-700 mb-2">
                      ...
                      <p className="text-sm text-gray-700 font-mono bg-gray-50 p-2 rounded">
                        ...
                        <br />
                        t_f = (4.34 + √(4.34² + 2×9.81×1.0)) / 9.81 ≈ 1.33 s<br />
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Advanced Effects</h3>
                    <ul className="text-gray-700 space-y-2">
                      <li>
                        <strong>Air Drag:</strong> Reduces range and increases flight time due to quadratic drag force
                      </li>
                      <li>
                        <strong>Car Rotation:</strong> Vehicle pitch affects landing attitude and stability
                      </li>
                      <li>
                        <strong>Safety Note:</strong> This is an educational model - real stunts require professional
                        engineering
                      </li>
                    </ul>
                  </div>
