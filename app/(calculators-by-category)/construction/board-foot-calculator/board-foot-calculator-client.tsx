...
interface BoardFootCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function BoardFootCalculatorClient({ content, guideContent }: BoardFootCalculatorClientProps) {
      ...
      <main className="py-8 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <RatingProfileSection
            entityId="board-foot-calculator"
