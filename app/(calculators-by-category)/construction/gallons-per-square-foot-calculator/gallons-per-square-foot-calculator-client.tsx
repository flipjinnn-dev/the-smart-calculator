...
interface GallonsPerSquareFootCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function GallonsPerSquareFootCalculatorClient({ content, guideContent }: GallonsPerSquareFootCalculatorClientProps) {
