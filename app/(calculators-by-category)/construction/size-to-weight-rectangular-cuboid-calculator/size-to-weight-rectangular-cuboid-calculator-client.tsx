...
interface SizeToWeightRectangularCuboidCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function SizeToWeightRectangularCuboidCalculatorClient({ content, guideContent }: SizeToWeightRectangularCuboidCalculatorClientProps) {
