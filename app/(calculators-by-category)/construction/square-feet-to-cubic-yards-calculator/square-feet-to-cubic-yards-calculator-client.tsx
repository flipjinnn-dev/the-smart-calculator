...
interface SquareFeetToCubicYardsCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function SquareFeetToCubicYardsCalculatorClient({ content, guideContent }: SquareFeetToCubicYardsCalculatorClientProps) {
