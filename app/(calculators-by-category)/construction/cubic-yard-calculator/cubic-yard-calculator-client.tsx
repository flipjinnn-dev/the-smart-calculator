...
interface CubicYardCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function CubicYardCalculatorClient({ content, guideContent }: CubicYardCalculatorClientProps) {
  ...
  const calculateVolume = () => {
    ...
    const A = unit === "ft" ? Number.parseFloat(baseArea) : unit === "in" ? Number.parseFloat(baseArea) / 144 : Number.parseFloat(baseArea) * 9;
      ...
      <main className="py-8 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <RatingProfileSection
            entityId="cubic-yard-calculator"
