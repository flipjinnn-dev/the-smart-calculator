...
interface SocialSecurityCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function SocialSecurityCalculatorClient({ content, guideContent }: SocialSecurityCalculatorClientProps) {
