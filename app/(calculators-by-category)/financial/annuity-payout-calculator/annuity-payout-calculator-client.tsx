...
interface AnnuityPayoutCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function AnnuityPayoutCalculatorClient({ content, guideContent }: AnnuityPayoutCalculatorClientProps) {
