...
interface FourOhOneKCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function FourOhOneKCalculatorClient({ content, guideContent }: FourOhOneKCalculatorClientProps) {
      ...
      <main className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <RatingProfileSection
            entityId="401k-calculator"
            entityType="calculator"
            creatorSlug="neo-nicholas"
            initialRatingTotal={15360}
            initialRatingCount={3200}
          />
          {/* Educational Content */}
