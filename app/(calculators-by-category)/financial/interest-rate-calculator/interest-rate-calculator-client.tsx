                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg border border-green-200">
                          <span className="font-medium text-gray-700">{contentData.total_of_11} {(Number.parseFloat(loanTermYears) || 0) * 12 + (Number.parseFloat(loanTermMonths) || 0)} {contentData.monthly_payments_12}</span>
                          <span className="font-bold text-green-600">
                            ${results.totalPayments.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                          </span>
                        </div>
