...
export default function CompoundInterestCalculatorClient({ content, guideContent }: CompoundInterestCalculatorClientProps) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="shadow-xl border-0 pt-0">
              ...
              <CardContent className="p-8 space-y-8">
                ...
                <Button onClick={calculateCompoundInterest} className="w-full h-12 text-lg bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 shadow-lg">
                  {contentData.calculate_11}
                </Button>
              </CardContent>
            </Card>
