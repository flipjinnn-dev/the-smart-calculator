...
interface AmortizationCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function AmortizationCalculatorClient({ content, guideContent }: AmortizationCalculatorClientProps) {
