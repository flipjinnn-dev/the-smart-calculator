...
interface EstateTaxCalculatorClientProps {
  content: any;
  guideContent: any;
}

export default function EstateTaxCalculatorClient({ content, guideContent }: EstateTaxCalculatorClientProps) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-green-50">
        ...
        <main className="py-8 px-4 sm:px-6 lg:px-8">
          ...
          <RatingProfileSection
            entityId="estate-tax-calculator"
