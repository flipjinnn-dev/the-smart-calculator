...
export async function GET() {
  ...
  // Static pages (Brazilian Portuguese)
  const staticPages = [
    { path: 'sobre-nos', priority: 0.7 },
    { path: 'contato', priority: 0.7 },
    { path: 'politica-de-privacidade', priority: 0.5 },
    { path: 'termos-e-condicoes', priority: 0.5 },
  ];
  ...
  // Category pages (Brazilian Portuguese) - Using dynamic function
  ...
  // All calculators (Brazilian URLs from metadata with complete paths)
