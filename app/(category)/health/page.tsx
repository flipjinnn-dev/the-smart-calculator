...
import { ArrowLeft, Calculator as CalculatorIcon, TrendingUp, Heart, Activity, Zap, CheckCircle2, BarChart3, Shield, Target, Users, Brain } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-green-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-green-600 to-teal-600 rounded-2xl mb-6 shadow-xl">
            <Heart className="w-10 h-10 text-white" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Health and Fitness Calculators for Better Wellness
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Use free health and fitness calculators online to track BMI, calories, heart rate, medical metrics and financial health for smarter wellness goals.
          </p>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 flex items-center">
            <CalculatorIcon className="mr-3 h-8 w-8 text-green-600" />
