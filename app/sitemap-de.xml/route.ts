...
export async function GET() {
  ...
  // Static pages (German)
  const staticPages = [
    { path: 'uber-uns', priority: 0.7 },
    { path: 'kontakt', priority: 0.7 },
    { path: 'datenschutz', priority: 0.5 },
    { path: 'nutzungsbedingungen', priority: 0.5 },
  ];
  ...
  // Category pages (German) - Using dynamic function
  ...
  // All calculators (German URLs from metadata with complete paths)
